                ...
                <Row>
                  <Col xl="4" sm="6">
                    <div className="current-balance"><span className="f-12 f-w-600">{YourCurrentBalance}</span>
                      <h2><span className="me-2"><i className="icofont icofont-cur-dollar"></i></span><span>{"6,00,566"}</span></h2>
                      ...
                      <div className="amount-detail">
                        ...
                        <div className="amount-inner">
                          <Row>
                            ...
                            <Col className="text-center">{"2023"}</Col>
                          </Row>
                        </div>
                      </div>
                      <div className="amount-detail">
                        ...
                        <div className="number-amount">
                          ...
                          <div className="amount-inner d-inline-block ms-1"><span>{"8"}</span></div>
                          <div className="amount-inner d-inline-block ms-1"><span>{"*"}</span></div>
            ...
            <Card>
              <CardBody className="distributed-crypto">
                <Row>
                  ...
                  <Col sm="6" className="text-end"><span className="f-12">{OurContributed}</span>
            ...
            <Card className="crypto-graph-card sales-overview">
              <CardHeader>
                <div className="media">
                  ...
                  </div><span className="pull-right badge rounded-pill"><span className="font-primary"><span className="d-inline-block"><i className="fa fa-sort-up"></i></span> {"7.8%"}</span></span>
                </div>
              </CardHeader>
              ...
              <CardHeader>
                <div className="media">
                  ...
                  <div className="right-setting">
                    <div className="setting-dot d-inline-block me-3">
                      <div className="setting-bg"><i className="fa fa-spin fa-cog font-secondary"></i></div>
                    </div><span className="pull-right badge rounded-pill"><span className="font-secondary"><span className="d-inline-block"><i className="fa fa-sort-up"></i></span> {"4.1%"}</span></span>
                  </div>
                </div>
              </CardHeader>
              <CardBody className="p-0 crm-dashboard-chart">
            ...
            <Card className="crypto-graph-card sales-overview warning-crypto">
              <CardHeader>
                <div className="media">
                  ...
                  </div><span className="pull-right badge rounded-pill"><span className="font-warning"><span className="d-inline-block"><i className="fa fa-sort-up"></i></span> {"4.1%"}</span></span>
                </div>
              </CardHeader>
              <CardBody className="p-0 crm-dashboard-chart">
                <div className="apex-chart-container">
            ...
            <Card>
              <CardHeader className="crypto-header">
                ...
                <div className="chart-value-box pull-right">
                  ...
                  <div className="value-square-box-secondary ms-3"></div><span className="f-12 f-w-600">{Value}</span>
                </div>
              </CardHeader>
              <CardBody>
                <div className="apex-chart-container">
                  ...
                  <div className="our-growth-bottom crypto-graph-card">
                    <div className="media"><span className="f-12 f-w-600">{OurGrowth}</span>
                      <span className="pull-right badge rounded-pill ms-3"><span className="font-primary">
                    ...
                    <tbody>
                      {marketData.map(data => (
                        <tr key={data.coin}>
                          ...
                          <td><span className={`badge rounded-pill f-14 ${data.className}`}>{data.change}</span></td>
                        </tr>
                      ))}
                    </tbody>
                  </Table>
