...
import { ProjectData, linechartsmooth } from "./chartsData/chartist";
import {
  SliderSettings,
  newProjectLineChartData,
  newProjectLineChartOption,
} from "./chartsData/chartJs";
import { category, clients, task } from "./data";
import {
  apexTotalUsers,
  crmSmallChart,
  doneProjectChart,
} from "./chartsData/apexChart";
...
import ProjectIncomeChartBody from "./ProjectIncomeChartBody";
          ...
          <Col xl="4" className="xl-40 box-col-12">
            <Card className="crm-chart-card">
              <CardHeader className="pb-0">
                <span className="mt-0">{SeptemberTotal}</span>
                <h3 className="mb-0">
                  {" "}
                  <span>
                    {" "}
                ...
                <span className="badge flat-badge-secondary d-inline-block">
                  {"+ 5.5% (10.1)"}
                </span>
              </CardHeader>
              <CardBody>
                <div className="dashboard-chart-container">
                  <div className="full-chart">
                    <ApexChart
                      options={linechartsmooth.options}
                      series={linechartsmooth.series}
                      type="line"
                      height={"100%"}
                      width={"100%"}
                    />
                  ...
                  <ul>
                    <li>
                      <a href="/#" className="text-decoration-none">
                        <h6 className="mb-0">{"1D"}</h6>
                      </a>
                    </li>
                    <li>
                      <a href="/#" className="text-decoration-none">
                        <h6 className="mb-0">{"2D"}</h6>
                      </a>
                    </li>
                    <li className="active">
                      <a href="/#" className="text-decoration-none">
                        <h6 className="mb-0">{"3D"}</h6>
                      </a>
                    </li>
                    <li>
                      <a href="/#" className="text-decoration-none">
                        <h6 className="mb-0">{"4D"}</h6>
                      </a>
                    </li>
                    <li>
                      <a href="/#" className="text-decoration-none">
                        <h6 className="mb-0">{"5D"}</h6>
                      </a>
                    </li>
                  </ul>
                  <Button className="btn gradient-danger btn-pill d-block w-100">
                    <span className="pull-left">{ViewFullChart}</span>
            ...
            <Slider {...SliderSettings}>
              {category.map((data) => (
                <div className="item" key={data.title}>
                  <div
                    className={`card crm-icon-box text-center ${data.classHover}`}
                  >
                    <div className="card-body">
                      <i className={`icofont ${data.className1}`}></i>
                      <i
                        className={`icofont crm-overlay ${data.className2}`}
                      ></i>
                      <h6>{data.title}</h6>
                    </div>
                  </div>
            ...
            <Card className="crm-total-user-card">
              <CardBody>
                ...
                <div className="total-user-title d-flex">
                  <h2 className="f-w-600">
                    {" "}
                    <span className="counter">{"85.3"}</span>
                    {"k"}
                  </h2>
                  <div className="setting-dot">
                    <div className="setting-bg pull-right">
              ...
              <div className="apex-chart-container">
                <div id="area-crm-chart">
                  <ApexChart
                    options={apexTotalUsers.options}
                    series={apexTotalUsers.series}
                    height="205"
                    type="area"
                  />
                </div>
          ...
          <Col xl="4" className="col-lg-6 xl-50 box-col-6">
            <Card className="crm-user-card">
              <CardHeader className="card-header">
                <div className="crm-user-top-content text-center">
                  <img className="img-fluid rounded-circle" src={user} alt="" />
                  <h4>{"Alena Ketrol"}</h4>
                  <span className="badge flat-badge-secondary">{"Our Md"}</span>
                </div>
              </CardHeader>
              <CardBody>
                <Row>
                  <Col sm="6">
                    <div className="apex-chart-small">
                      <div id="area-crm-chart-small">
                        <ApexChart
                          options={crmSmallChart.options}
                          series={crmSmallChart.series}
                          height="120"
                          width="140"
                          type="area"
                        />
            ...
            <Card className="crm-total-user-card done-project-card">
              ...
              <div className="apex-chart-container">
                <div id="area-crm-chart-1">
                  <ApexChart
                    options={doneProjectChart.options}
                    series={doneProjectChart.series}
                    height="205"
                    type="area"
                  />
                </div>
                        ...
                        <tr key={data.id}>
                          ...
                          <td>
                            <div className="d-inline-block align-middle">
                              <img
                                className="img-radius img-30 m-r-15 rounded-circle"
                                src={data.imagepath}
                                alt=""
                              />
                          ...
                          <td>
                            <i className={`flag-icon ${data.country}`}></i>
                          </td>
                          <td>
                            <span>{data.date}</span>
                          </td>
                          <td>
                            <img className="img-30" src={data.payment} alt="" />
                          </td>
                          <td>
                            <span>
                              {data.total}
                          ...
                          <td>
                            <span className="status-position">
                              <i className={`fa fa-circle ${data.statusClass}`}>
                                {" "}
                              </i>
                              {data.status}
                            </span>
            ...
            <Card>
              ...
              <CardBody className="crm-dashboard-chart">
                <div className="crm-top-chart">
                  <h1 className="font-secondary mb-0 counter">{"26"}</h1>
                  <span>{TotalNewProject}</span>
                  <span className="d-block f-12">
                    <span className="d-inline-block up-icon-middle">
                      <i className="fa fa-sort-up me-1 font-secondary"> </i>
                    </span>
                    {"100%"}
                  </span>
                </div>
                <Line
                  data={newProjectLineChartData}
                  options={newProjectLineChartOption}
                  height={100}
                />
              </CardBody>
            </Card>
          ...
          <Col xl="8" className="xl-100 box-col-12">
            <Card>
              ...
              <CardFooter className="quick-mail-footer">
                ...
                <Button className="btn btn-transparent btn-clip ms-1">
                  <Paperclip />
                </Button>
              </CardFooter>
            </Card>
          ...
          <Col xl="4" className="xl-50 box-col-6">
            <Card className="crm-user-profile-card">
              <CardHeader className="p-0 profile-top-bg">
                ...
                <div className="profile-round profile-round-medium animation-round-2">
                  {" "}
                </div>
                  ...
                  <div className="media d-flex">
                    ...
                    <div className="media-body flex-grow-1">
                      ...
                      <span className="f-12 d-block">
                        {"Alexgoldmine_98@gmail.com"}
                      </span>
                      <span className="badge rounded-pill bg-white font-info">
                        {Admin}
                      </span>
                    </div>
                  </div>
                ...
                <ul>
                  ...
                  <li>
                    <h6>
                      ...
                      <CreditCard />
                      {InvoicesAndPayments}
                      <span className="pull-right badge rounded-pill pill-badge-secondary">
                        {"2"}
                      </span>
                    </h6>
                  </li>
            ...
            <Card>
              ...
              <CardBody className="p-0">
                <div className="my-tasks">
                  {task.map((data) => (
                    <div className="media d-flex" key={data.id}>
                      <div
                        className={`checkbox checkbox-square-${data.classname}`}
                      >
                      ...
                      <div className="media-body flex-grow-1">
                        ...
                        <p>{data.task}</p>
                        <span
                          className={`badge rounded-pill badge-${data.classname}`}
                        >
                          {data.status}
                        </span>
                      </div>
            ...
            <Card>
              <CardHeader>
                ...
                <div className="crm-chat-status">
                  ...
                  <img className="img-30 rounded-circle" src={user} alt="" />
                  <img
              ...
              <CardBody className="chat-box crm-chat">
                <div className="chat">
                  <div className="media d-flex left-side-chat">
                    <img
                    ...
                    />
                    <div className="media-body flex-grow-1">
                      <span className="f-12">{"Message seen 4:07 PM"}</span>
                  ...
                  <div className="media d-flex right-side-chat">
                    <div className="media-body flex-grow-1 text-end">
                      <span className="f-12 d-block">
                        {"Message seen 4:10 PM"}
                      </span>
                  ...
                  <div className="media d-flex left-side-chat">
                    ...
                    />
                    <div className="media-body flex-grow-1">
                      <span className="f-12">{"Message seen 4:15 PM"}</span>
                      <div className="message-main">
            ...
            <Card>
              ...
              <CardBody>
                <div className="timeline-circle">
                  <div className="media d-flex">
                    <span className="f-12">{"11:20"}</span>
                    ...
                    <div className="media-body flex-grow-1">
                      ...
                      <p className="f-12">
                        {"Quisque a consequat ante, at volutpat enim."}
                      </p>
                    </div>
                  </div>
                  <div className="media d-flex">
                    <span className="f-12">{"Today"}</span>
                    <div className="timeline-background">
                  ...
                  <div className="media d-flex">
                    <span className="f-12">{"05:04"}</span>
                    <div className="timeline-background">
                  ...
                  <div className="media d-flex">
                    <span className="f-12">{"08:20"}</span>
                    <div className="timeline-background">
                  ...
                  <div className="media d-flex">
                    <span className="f-12">{"Last Week"}</span>
                    <div className="timeline-background">
                    ...
                    <div className="media-body flex-grow-1">
                      ...
                      <p className="f-12">
                        {"Vestibulum nec mi suscipit, dapibus purus a "}{" "}
                      </p>
                    </div>
                  </div>
                </div>
