...
import {  AnimationLineOptions, Animationline,  smallChart1, smallChart2, smallChart3 } from './chartsData/chartist'
...
import { Chart as ChartJS, Title, Tooltip, LineElement, Legend, Filler, LinearScale } from 'chart.js'
import { CategoryScale } from 'chart.js'
ChartJS.register(
  Title, Tooltip, LineElement, Legend, Filler, CategoryScale, LinearScale
)
const Hospital = () => {
        ...
        <Row>
          <Col xl="3" className="xl-50 col-6 hospital-patients box-col-6">
            <Card className="o-hidden">
              <CardBody>
                <div className="hospital-widgets media d-flex">
            ...
            <Card>
              <CardBody>
                <Row className="r-hospital-chart">
                  <Col xl="4" md="4" sm="6">
                    <div className="media hospital-small-chart d-flex">
                      <div className="small-bar">
                        <div className="small-chart flot-chart-container">
                          <ApexChart options={smallChart1.options} series={smallChart1.series} type='bar' height={80} />
                        </div>
                      </div>
                      <div className="media-body">
                    ...
                    <div className="media hospital-small-chart d-flex">
                      <div className="small-bar">
                        <div className="small-chart1 flot-chart-container">
                          <ApexChart options={smallChart2.options} series={smallChart2.series} type='bar' height={80} />
                        </div>
                      </div>
                      <div className="media-body">
                    ...
                    <div className="media hospital-small-chart d-flex">
                      <div className="small-bar">
                        <div className="small-chart2 flot-chart-container">
                          <ApexChart options={smallChart3.options} series={smallChart3.series} type='bar' height={80}  />
                        </div>
                      </div>
                      <div className="media-body">
            ...
            <Card>
              ...
              <CardBody>
                <div className="apex-chart-container chart-data">
                  <div id="column-chart">
                    <ApexChart options={apexBarChart.options} series={apexBarChart.series} height="280" type="bar" />
                  </div>
                </div>
              </CardBody>
            </Card>
            ...
            <Card className="crm-user-card hospital-user height-equal">
              <CardHeader>
                <div className="crm-user-top-content text-center"><img className="img-fluid rounded-circle" src={p1} alt="" />
                  <h4> <span className="me-2"><i className="f-20 font-secondary mdi mdi-cards-heart"></i></span>{"Henry Ketrol"}</h4><span className="badge flat-badge-secondary">{Specialist}</span>
                </div>
              </CardHeader>
              <CardBody>
                <Row>
                  <Col xs="6">
                    <div className="apex-chart-small">
                      <div id="hospital-area-chart-small">
                        <ApexChart options={apexSmallChart.options} series={apexSmallChart.series} height="120" width="140" type="area" />
                      </div>
                    </div>
                  </Col>
                  <Col xs="6">
            ...
            <Card className="height-equal">
              ...
              <CardBody className="pb-0">
                <div className="timeline-circle hospital-timeline">
                  <div className="media mt-0 d-flex">
              ...
              <CardBody className="p-0">
                <div className="sales-product-table table-responsive booked-table">
                  <Table borderless className="text-center">
                    ...
                    <tbody>
                      {bookedAppoinment && bookedAppoinment.map(data => (
                        <tr key={data.id}>
                          <td>{data.id}</td>
                          <td>
                          ...
                          <td><span className={`badge rounded-pill pill-badge-${data.className}`}>{Action}</span></td>
                        </tr>
                      ))}
                    </tbody>
                  </Table>
