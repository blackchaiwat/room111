...
export const SubNavToggle = (props) => {
  ...
  return (
    <Fragment>
      <li>
        <button className="btn btn-link text-muted" onClick={Advance} aria-expanded={expanded1}><FolderPlus/><span> Advance</span></button>
      ...
      <li>
        <button className="btn btn-link text-muted" onClick={Tables} aria-expanded={expanded2}><Server/> Tables</button>
