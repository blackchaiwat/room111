                  ...
                  <CardBody className="card-body">
                    <div className="mb-3">
                      <Button color="primary">
                        {Messages} <Badge color="light text-dark ms-1" pill><Mail/></Badge>
                      </Button>
                    </div>
                    <div className="mb-3">
                      <Button color="secondary" type="button">
                        {Notification} <Badge color="light text-dark ms-1" pill><Bell/></Badge></Button>
                    </div>
                    <div className="mb-3">
                      <Button color="success">{"Update available"} <Badge color="light text-dark ms-1" pill><Settings/></Badge></Button>
                    </div>
                    <div className="mb-3">
                      <Button color="info text-light">{"Playing Now"} <Badge color="light text-dark ms-1" pill><Music/></Badge></Button>
                    </div>
                    <div className="mb-3">
                      <Button color="warning">{"1.2 GB Used"} <Badge color="light text-dark ms-1" pill><AlertTriangle/></Badge></Button>
                    </div>
                    <div>
                      <Button color="danger">{"Alert"} <Badge color="light text-dark ms-1" pill><AlertCircle/></Badge></Button>
                    </div>
                  </CardBody>
                </div>
              </Col>
