                ...
                <Card>
                  ...
                  <CardBody>
                    <ListGroup>
                      ...
                      <ListGroupItem className="d-flex justify-content-between align-items-center">{"Cras justo odio"}<span className="badge badge-light text-dark counter digits">{"14"}</span></ListGroupItem>
                    </ListGroup>
                  </CardBody>
                </Card>
              </Col>
