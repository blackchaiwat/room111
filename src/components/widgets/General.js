...
import { Container, Row, Col, Card, CardBody, CardHeader, Button, CardFooter, Table, Input, Label, Form } from 'reactstrap'
            ...
            <Card className="o-hidden">
              <CardBody className="bg-primary b-r-4 card-body">
                <div className="media static-top-widget d-flex">
                  ...
                  <div className="media-body flex-grow-1"><span className="m-0">{Earnings}</span>
            ...
            <Card className="o-hidden">
              <div className="bg-secondary b-r-4 card-body">
                <div className="media static-top-widget d-flex">
                  ...
                  <div className="media-body flex-grow-1"><span className="m-0">{Products}</span>
            ...
            <Card className="o-hidden">
              <CardBody className="bg-primary b-r-4">
                <div className="media static-top-widget d-flex">
                  ...
                  <div className="media-body flex-grow-1"><span className="m-0">{Messages}</span>
            ...
            <Card className="o-hidden">
              <CardBody className="bg-primary b-r-4">
                <div className="media static-top-widget d-flex">
                  ...
                  <div className="media-body flex-grow-1"><span className="m-0">{NewUser}</span>
            ...
            <Card className="widget-joins widget-arrow">
              <Row>
                <Col sm="6" className="pe-0">
                  <div className="media border-after-xs d-flex">
                    <div className="align-self-center me-3 text-start">
                      <h6 className="mb-1">{Sale}</h6>
                      <h4 className="mb-0">{Today}</h4>
                    </div>
                    <div className="media-body align-self-center flex-grow-1"><ArrowDown className="font-primary" /></div>
                ...
                <Col sm="6" className="ps-0">
                  <div className="media d-flex">
                    ...
                    <div className="media-body flex-grow-1 align-self-center"><ArrowUp className="font-primary" /></div>
                ...
                <Col sm="6" className="pe-0">
                  <div className="media d-flex border-after-xs">
                    <div className="align-self-center me-3 text-start">
                      <h6 className="mb-1">{Sale}</h6>
                ...
                <Col sm="6" className="ps-0">
                  <div className="media d-flex">
                    ...
                    <div className="media-body flex-grow-1 align-self-center ps-3"><ArrowUp className="font-primary" /></div>
                    <div className="media-body ps-2">
              ...
              <Row>
                <Col sm="6" className="pe-0">
                  <div className="media d-flex border-after-xs">
                    ...
                    <div className="media-body flex-grow-1 details ps-3"><span className="mb-1">{New}</span>
                ...
                <Col sm="6" className="ps-0">
                  <div className="media d-flex">
                    ...
                    <div className="media-body flex-grow-1 details ps-3"><span className="mb-1">{Pending}</span>
                ...
                <Col sm="6" className="pe-0">
                  <div className="media d-flex border-after-xs">
                    <div className="align-self-center me-3">{"68%"}<i className="fa fa-angle-up ms-2"></i></div>
                    <div className="media-body flex-grow-1 details ps-3 pt-0"><span className="mb-1">{Done}</span>
                ...
                <Col sm="6" className="ps-0">
                  <div className="media d-flex">
                    <div className="align-self-center me-3">{"68%"}<i className="fa fa-angle-up ms-2"></i></div>
                    <div className="media-body flex-grow-1 details ps-3 pt-0"><span className="mb-1">{Cancel}</span>
                ...
                <Row>
                  <Col xl="6" xs="12" md="6" sm="6">
                    <div className="cal-info text-center">
                      <h2>{"24"}</h2>
                      <div className="d-inline-block mt-2"><span className="b-r-dark pe-3">{"March"}</span><span className="ps-3">{"2023"}</span></div>
              ...
              <div className="weather-widget-two">
                <CardBody>
                  <div className="media d-flex">
                    ...
                    <div className="media-body flex-grow-1 align-self-center text-white">
          ...
          <Col xl="4" className="box-col-6">
            <Card className="custom-card widget-profile">
              ...
              <ul className="card-social">
                ...
                <li><a href="https://twitter.com/login"><i className="fa fa-twitter"></i></a></li>
                <li><a href="https://www.instagram.com/"><i className="fa fa-instagram"></i></a></li>
                <li><a href="https://rss.app/"><i className="fa fa-rss"></i></a></li>
              </ul>
