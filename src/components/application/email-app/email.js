                    ...
                    <div className="email-app-sidebar">
                      ...
                      <ul className="nav main-menu" role="tablist">
                        <li className="nav-item">
                          <a
                            className="btn-primary d-block w-100 btn-mail"
                          ...
                          <div className="email-top compose-border">
                            <Row>
                              ...
                              <Col sm="4 xl-50" className="btn-middle">
                                <Button
                                  color="primary"
                                  className="d-block w-100 btn-mail text-center mb-0 mt-0"
                                >
                        ...
                        <div className="email-content">
                                  ...
                                  <Media body>
                                    <h6>
                                      ...
                                      <small>
                                        ...
                                        <span className="digits">{"6:00"}</span>{" "}
                                        {"AM"}
                                      </small>
                                    </h6>
                          ...
                          <div className="email-wrapper">
                            ...
                            <div className="d-inline-block">
                              ...
                              <a
                                className="text-muted text-end right-download"
                                href="#javascript"
                              >
