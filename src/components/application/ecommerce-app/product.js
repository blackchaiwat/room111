...
const Product = (props) => {
  ...
  const addWishList = (product) => {
    ...
    navigate(`${process.env.PUBLIC_URL}/ecommerce/wishlist`);
  }
  ...
  const onClickDetailPage = (product) => {
    const id = product.id;
    navigate(`${process.env.PUBLIC_URL}/ecommerce/product-detail/${id}`)
  }
                        ...
                        <Col lg="6" className="product-details  text-start">
                          ...
                          <div className="product-qnty">
                            ...
                            <div className="addcart-btn">
                              <Link to={`${process.env.PUBLIC_URL}/ecommerce/cart`}><Button color="primary" className="me-2 mt-2" onClick={() => addcart(singleProduct, quantity)}>{AddToCart}</Button></Link>
