                            ...
                            <Row className="default-according style-1 faq-accordion" id="accordionoc">
                                <div className="col-xl-8 xl-60 col-lg-6 col-md-7">
                                    <Card>
                                        <CardHeader>
                                            <h5 className="mb-0">
                                                <Button color="btn btn-link collapsed ps-0" onClick={() => setIsCollaps(!isCollaps)}
                                                     aria-expanded={isCollaps} aria-controls="collapseicon">
                                                    <HelpCircle />
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <h5 className="mb-0">
                                                <Button color="btn btn-link collapsed ps-0" onClick={() => setIsCollaps1(!isCollaps1)}
                                                      aria-expanded={isCollaps1} aria-controls="collapseicon2">
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <h5 className="mb-0">
                                                <Button color="btn btn-link collapsed ps-0" onClick={() => setIsCollaps2(!isCollaps2)}
                                                     aria-expanded={isCollaps2} aria-controls="collapseicon2">
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <h5 className="mb-0">
                                                <Button color="btn btn-link collapsed ps-0" onClick={() => setIsCollaps3(!isCollaps3)}
                                                     aria-expanded={isCollaps3} aria-controls="collapseicon2">
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <h5 className="mb-0">
                                                <Button color="btn btn-link collapsed ps-0" onClick={() => setIsCollaps4(!isCollaps4)}
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <h5 className="mb-0">
                                                <Button color="btn btn-link collapsed ps-0" onClick={() => setIsCollaps5(!isCollaps5)}
                                                     aria-expanded={isCollaps5} aria-controls="collapseicon2">
                                                    <HelpCircle /> {"WordPress in Your Language ?"}</Button>
                                            </h5>
                                        </CardHeader>
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <h5 className="mb-0">
                                                <Button color="btn btn-link collapsed ps-0" onClick={() => setIsCollaps6(!isCollaps6)}
                                                    aria-expanded={isCollaps6} aria-controls="collapseicon2">
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <h5 className="mb-0">
                                                <Button color="btn btn-link collapsed ps-0" onClick={() => setIsCollaps7(!isCollaps7)}
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <h5 className="mb-0">
                                                <Button color="btn btn-link collapsed ps-0" onClick={() => setIsCollaps8(!isCollaps8)}
                                                     aria-expanded={isCollaps8} aria-controls="collapseicon2">
                                                    <HelpCircle />{"Meta Tags in WordPress ?"}</Button>
                                            </h5>
                                        </CardHeader>
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <h5 className="mb-0">
                                                <Button color="btn btn-link collapsed ps-0" onClick={() => setIsCollaps9(!isCollaps9)}
                                                     aria-expanded={isCollaps9} aria-controls="collapseicon2">
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <h5 className="mb-0">
                                                <Button color="btn btn-link collapsed ps-0" onClick={() => setIsCollaps10(!isCollaps10)}
                                                     aria-expanded={isCollaps10} aria-controls="collapseicon2">
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <h5 className="mb-0">
                                                <Button color="btn btn-link collapsed ps-0" onClick={() => setIsCollaps11(!isCollaps11)}
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <h5 className="mb-0">
                                                <Button color="btn btn-link collapsed ps-0" onClick={() => setIsCollaps12(!isCollaps12)}
                                                     aria-expanded={isCollaps12} aria-controls="collapseicon2">
                                                    <HelpCircle />{"WordPress Site Maintenance ?"}</Button>
                                            </h5>
                                        </CardHeader>
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <h5 className="mb-0">
                                                <Button color="btn btn-link collapsed ps-0" onClick={() => setIsCollaps13(!isCollaps13)}
                                                     aria-expanded={isCollaps13} aria-controls="collapseicon2">
                                                    <HelpCircle /> {"WordPress in Your Language ?"}</Button>
                                            </h5>
                                        </CardHeader>
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <h5 className="mb-0">
                                                <Button color="btn btn-link collapsed ps-0" onClick={() => setIsCollaps14(!isCollaps14)}
                                                     aria-expanded={isCollaps14} aria-controls="collapseicon2">
                                                    <HelpCircle />  {"Validating a Website ?"}</Button>
                                            </h5>
                                        </CardHeader>
                                    ...
                                    <Card>
                                        <CardHeader>
                                            <h5 className="mb-0">
                                                <Button color="btn btn-link collapsed ps-0" onClick={() => setIsCollaps15(!isCollaps15)}
                                                     aria-expanded={isCollaps15} aria-controls="collapseicon2">
                                                    <HelpCircle />{"Meta Tags in WordPress ?"}</Button>
                                            </h5>
                                        </CardHeader>
                            ...
                            <Row>
                                <Col xl="3 xl-50 box-col-6" md="6">
                                    <Card className="features-faq product-box">
                                        ...
                                        <div className="card-footer"><span>{"Dec 15, 2023"}</span><span className="pull-right"><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i></span></div>
                                    </Card>
                                </Col>
                                <Col xl="3 xl-50 box-col-6" md="6">
                                    <Card className="features-faq product-box">
                                        ...
                                        <div className="card-footer"><span>{"Dec 15, 2023"}</span><span className="pull-right"><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star-o font-primary"></i></span></div>
                                    </Card>
                                </Col>
                                <Col xl="3 xl-50 box-col-6" md="6">
                                    <Card className="features-faq product-box">
                                ...
                                <Col xl="3 xl-50 box-col-6" md="6">
                                    <Card className="features-faq product-box">
                                        ...
                                        <div className="card-footer"><span>{"Dec 15, 2023"}</span><span className="pull-right"><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star font-primary"></i><i className="fa fa-star-half-o font-primary"></i></span></div>
                                    </Card>
                                </Col>
                            </Row>
                        </Col>
