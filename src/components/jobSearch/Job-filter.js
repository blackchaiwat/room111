                        ...
                        <Col xl="12">
                            <Card>
                                ...
                                <Collapse isOpen={location}>
                                    ...
                                    <Button className="d-block w-100 text-center" color="primary">{AllLocations}</Button>
                                </Collapse>
                            </Card>
                        </Col>
                        <Col xl="12">
                            <Card>
                                ...
                                <Collapse isOpen={isJobTitle}>
                                    ...
                                    <Button className="d-block w-100 text-center" color="primary">{AllJobTitle}</Button>
                                </Collapse>
                            </Card>
                        </Col>
                        <Col xl="12">
                            <Card>
                                ...
                                <Collapse isOpen={isIndustry}>
                                    <div className="collapse show" id="collapseicon3" data-parent="#accordion" aria-labelledby="collapseicon3">
                                        ...
                                        <Button className="d-block w-100 text-center" color="primary">{AllIndustries}</Button>
                                    </div>
                                </Collapse>
                            </Card>
                        </Col>
                            ...
                            <Card>
                                ...
                                <Collapse isOpen={isSkill}>
                                    <div className="collapse show" id="collapseicon4" data-parent="#accordion" aria-labelledby="collapseicon4">
                                        ...
                                        <Button className="d-block w-100 text-center" color="primary">{AllSkills}</Button>
                                    </div>
                                </Collapse>
                            </Card>
                        </Col>
