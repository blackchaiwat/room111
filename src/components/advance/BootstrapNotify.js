              ...
              <Col sm="12">
                <Card>
                  ...
                  <CardBody className="btn-showcase">
                    ...
                    <Button  name="basicinfoToast" color="info text-light" onClick={(e) => basictoaster(e.target.name)}>{InfoNotification}</Button>
              ...
              <Col sm="12">
                <Card>
                  ...
                  <CardBody className="btn-showcase">
                    ...
                    <Button  name="directionsinfoToast" color="info text-light" onClick={(e) => directiontoaster(e.target.name)}>{BottomCenter}</Button>
              ...
              <Col sm="12">
                <Card>
                  ...
                  <CardBody className="btn-showcase">
                    ...
                    <Button  name="autoclose2Toast" color="info text-light" onClick={(e) => autoclosetoaster(e.target.name)}>{AutoCloseIn5000Sec}</Button>
