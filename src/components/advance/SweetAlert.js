              ...
              <Col sm="12">
                <Card>
                  ...
                  <CardBody  className="btn-showcase">
                    ...
                    <Button color="info text-light" className="sweet-4"     name="basicinfoalert" onClick={(e) => Displayalert(e.target.name)}>{InfoAlert}</Button>
              ...
              <Col sm="12">
                <Card>
                  ...
                  <CardBody  className="btn-showcase">
                    ...
                    <Button color="info text-light" className="sweet-13" name="advanceInfo" onClick={(e) => Displayalert(e.target.name)}>{Information}</Button>
              ...
              <Col sm="12">
                <Card>
                  ...
                  <CardBody  className="btn-showcase">
                    ...
                    <Button color="info text-light" className="sweet-9" name="alertInfo" onClick={(e) => Displayalert(e.target.name)} >{Information}</Button>
