...
import { Container, Row, Col, Card, CardHeader, CardBody, Form,  Label, Input, Media, Dropdown, DropdownMenu, DropdownToggle, DropdownItem, TabContent, TabPane, Nav, NavItem, NavLink, Pagination, PaginationItem, PaginationLink } from 'reactstrap';
...
const Search = () => {
  ...
  let imagesData = [1, 2, 3, 4, 5, 6, 7, 8,];
