                        ...
                        <Card>
                            ...
                            <CardBody className="btn-group-showcase">
                                <Row>
                                    ...
                                    <Col xl="4" md="6" sm="12">
                                        <ButtonGroup>
                                            <Button color="info text-light">{Left}</Button>
                                            <Button color="info text-light">{Middle}</Button>
                                            <Button color="info text-light">{Right}</Button>
                                        </ButtonGroup>
                                    </Col>
                                    <Col xl="4" md="6" sm="12">
                                        <ButtonGroup>
                        ...
                        <Card>
                            ...
                            <CardBody className="btn-group-showcase">
                                <Row>
                                    ...
                                    <Col xl="6" sm="12">
                                        <ButtonGroup>
                                            <Button size="lg" color="info text-light">{Left}</Button>
                                            <Button size="lg" color="info text-light">{Middle}</Button>
                                            <Button size="lg" color="info text-light">{Right}</Button>
                                        </ButtonGroup>
                                    </Col>
                                    <Col xl="6" sm="12">
                                        <ButtonGroup>
                                    ...
                                    <Col xl="4" md="6" sm="12">
                                        <div className="btn-radio">
                                            <ButtonGroup>
                                                ...
                                                <Button color="info text-light" active>
                                                    <div className="radio radio-info">
                            ...
                            <CardBody className="btn-group-wrapper">
                                ...
                                <div className="m-b-30">
                                    <ButtonGroup>
                                        ...
                                        <Button color="info text-light"><i className="fa fa-paperclip"></i></Button>
                                    </ButtonGroup>
                                </div>
                                <div className="m-b-30">
                                    <ButtonGroup>
                                        ...
                                        <Button color="info text-light" size="lg" ><i className="fa fa-paperclip"></i></Button>
                                    </ButtonGroup>
                                </div>
                            </CardBody>
                        </Card>
                        ...
                        <Card className="height-equal">
                            ...
                            <CardBody className="btn-group-wrapper">
                                <ButtonGroup vertical >
                                    ...
                                    <Button color='info text-light' type="button" className="b-r-0">{"Button"}</Button>
