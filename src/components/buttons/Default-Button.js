                    ...
                    <Col sm="12">
                        <Card>
                            ...
                            <CardBody className="btn-showcase">
                                ...
                                <Button color="info text-light">{InfoButton}</Button>
                        ...
                        <Card id="large-btn">
                            ...
                            <CardBody className="btn-showcase">
                                ...
                                <Button color="info text-light" size="lg">{InfoButton}</Button>
                        ...
                        <Card id="small-btn">
                            ...
                            <CardBody className=" btn-showcase">
                                ...
                                <Button color="info text-light" size="sm">{InfoButton}</Button>
                        ...
                        <Card id="ex-small-btn">
                            ...
                            <CardBody className=" btn-showcase">
                                ...
                                <Button color="info text-light" size="xs">{InfoButton}</Button>
                        ...
                        <Card id="active-btn">
                            ...
                            <CardBody className=" btn-showcase">
                                ...
                                <Button color="info text-light" active >{Active}</Button>
                        ...
                        <Card id="disabled-btn">
                            ...
                            <CardBody className=" btn-showcase">
                                ...
                                <Button color="info text-light" disabled>{Disabled}</Button>
                        ...
                        <Card id="custom-state-button">
                            ...
                            <CardBody className=" btn-showcase"><a className="btn btn-primary" href="#javascript" data-toggle="tooltip" title="btn btn-primary" role="button">{"Link"}</a>
                                ...
                                <Button color="info text-light" type="submit">{"Button"}</Button>
                            </CardBody>
                        </Card>
