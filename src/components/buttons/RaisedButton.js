              ...
              <Col sm="12">
                  <Card>
                      ...
                      <CardBody className="btn-showcase">
                          ...
                          <Button className="btn-pill btn-air-info text-light" color="info">{InfoButton}</Button>
                  ...
                  <Card>
                      ...
                      <CardBody className="btn-showcase">
                          ...
                          <Button className="btn-pill btn-air-info text-light" size="lg" color="info">{InfoButton}</Button>
                  ...
                  <Card>
                      ...
                      <CardBody className="btn-showcase">
                          ...
                          <Button   className="btn-pill btn-air-info text-light"  color="info" size="sm">{InfoButton}</Button>
                  ...
                  <Card>
                      ...
                      <CardBody className="btn-showcase">
                          ...
                          <Button  className="btn-pill btn-air-info text-light"  color="info" size="xs">{InfoButton}</Button>
                  ...
                  <Card>
                      ...
                      <CardBody className="btn-showcase">
                          ...
                          <Button  className="btn-pill btn-air-info text-light"  color="info" active >{Active}</Button>
                  ...
                  <Card>
                      ...
                      <CardBody className="btn-showcase">
                          ...
                          <Button  className="btn-pill btn-air-info text-light"  color="info" disabled>{Disabled}</Button>
                  ...
                  <Card>
                      ...
                      <CardBody className="btn-showcase"><a className="btn btn-pill btn-air-primary btn-primary" href="#javascript" data-toggle="tooltip" title="btn btn-primary" role="button">{"Link"}</a>
                          ...
                          <button className="btn btn-pill btn-air-info btn-info text-light" type="submit">{"Button"}</button>
                      </CardBody>
                  </Card>
                  <Card>
                      <CardHeader>
