...
export const MENUITEMS = [
    ...
    {
        title: 'Campaigns', icon: Archive, type: 'sub', badgeType: 'primary', active: false, children: [
            { path: `${process.env.PUBLIC_URL}/campaign/overview`, title: 'Overview', type: 'link' },
            { path: `${process.env.PUBLIC_URL}/campaign/active`, title: 'Campaign Active', type: 'link' },
            { path: `${process.env.PUBLIC_URL}/campaign/history`, title: 'Campaign History', type: 'link' },
            { path: `${process.env.PUBLIC_URL}/campaign/form/create`, title: 'Create Campaign', type: 'link' },
        ]
    },
    {
        title: 'Audience', icon: Star, type: 'sub', badgeType: 'primary', active: false, children: [
            { path: `${process.env.PUBLIC_URL}/audience/target-audience`, title: 'Audience Group', type: 'link' },
            { path: `${process.env.PUBLIC_URL}/audience/audience-form/create`, title: 'Create Audience', type: 'link' },
        ]
    },
    {
        title: 'Register Profile', icon: Users, type: 'link', path: `${process.env.PUBLIC_URL}/influ/list`, active: false
    },
    {
        title: 'Commission', icon: DollarSign, type: 'sub', badgeType: 'primary', active: false, children: [
            { path: `${process.env.PUBLIC_URL}/commission/campaign`, title: 'Campaign', type: 'link' },
            { path: `${process.env.PUBLIC_URL}/commission/friend`, title: 'Friend get Friend', type: 'link' },
        ]
    },
    ...
    //                 { title: 'DateTimepicker', type: 'link', path: `${process.env.PUBLIC_URL}/form-widget/timepicker` },
    ...
    //                 { path: `${process.env.PUBLIC_URL}/forms/formWizard1`, title: 'Form Wizard 1', type: 'link' },
    //                 { path: `${process.env.PUBLIC_URL}/forms/formWizard2`, title: 'Form Wizard 2', type: 'link' },
    //                 { path: `${process.env.PUBLIC_URL}/forms/formWizard3`, title: 'Form Wizard 3', type: 'link' },
    //             ]
    //         },
    //     ]
    // },
    ...
    // },
    // {
    //     title: 'Social App', icon: Chrome, type: 'link', path: `${process.env.PUBLIC_URL}/social-app/socialApp`, active: false , bookmark: true
    // },
    // {
